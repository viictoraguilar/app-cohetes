...
Clonar repositorio
Installar Modulos con npm install
arrancar proyecto con el comando gatsby develop
...
Terminar de realizar la conexión de API de Space X con Dato CMS para poder gestionar los contenidos desde este gestor facilitando el manejo para los usuarios

# ¿Qué haría de manera diferente si se le asignara más tiempo?

Ya con previa documentación de graphql y Apollo segementaria de mejor manera las historias de usuario para priorizar tiempos de desarrollo
